...
class ItemController extends AppBaseController
{
    ...
    {
        $query = Item::where(['status' => BaseModel::STATUS_ENABLE]);
        ...
        return $this->sendResponse($items->toArray(), 'Items retrieved successfully', $total);
    }
    ...
    public function itemSetByParent($parent_id){
