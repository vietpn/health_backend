...
return [
    ...
    */
    ...
    "range_number" => "The :attribute not in range",
    "latitue" => "The :attribute about from -90 to 90",
    "longtitue" => "The :attribute about from -180 to 180",
    "old_password" => "The :attribute is incorrect",
    "unique_name"   =>  "指定の:attributeは既に使用されています。",
    "unique_email"   =>  "指定の:attributeは既に使用されています。",
    "unique_imei"   =>  "指定の:attributeは既に使用されています。",
];
