    ...
    <table class="table table-responsive table-striped table-bordered table-hover" id="orders-table">
        ...
        <tr>
            ...
            <td>
                ...
                <div>
                    <a href="{!! route('backend.orders.download', [$order->id]) !!}" class='btn btn-default '><i
                                class="glyphicon glyphicon-download"></i></a>
                    <a href="{!! route('backend.orders.show', [$order->id]) !!}" class='btn btn-default '><i
                                class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('backend.orders.edit', [$order->id]) !!}" class='btn btn-default '><i
